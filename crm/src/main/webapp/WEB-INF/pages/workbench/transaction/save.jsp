...
<script type="text/javascript">
    $(function (){
       ...
       $("#create-stage").change(function (){
           //收集参数
           //alert($(this).find("option:selected").text()); find函数
           var stageValue = $("#create-stage option:selected").text();//父子选择器
           //表单验证
           if(stageValue==""){
                //清空可能性输入框
...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="hidden" id="create-activityId" value="2210e80dc8ee4b0bb495a32fb36578ce">
            <input type="text" class="form-control" id="create-activityName" value="ii测试01">
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a
                ...
                class="glyphicon glyphicon-search"></span></a></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="hidden" id="create-contactsId" value="02054f94585c442da8e9767d700b9243">
            <input type="text" class="form-control" id="create-contactsName" value="bill gas">
        </div>
    </div>
